export default {
  language_drag_and_drop: 'Fais glisser pour sélectionner la langue',
  ...
  vote_tutorial_1_title: 'Bienvenue !',
  vote_tutorial_1_text: "Choisis le sujet qui t'intéresse dans la liste ci-dessous et vote !",
  vote_tutorial_2_title: "C'est l'heure de voter !",
  vote_tutorial_2_text: 'À droite : tu es pour, à gauche : tu es contre. À toi de décider !',
  ...
  see_all_votes: 'Afficher les sujets précédents.',
  ...
  proposal_list_header_newest: 'Plus récents',
  ...
  map_you_label: 'Toi',
  map_letter_friends_label: 'Lettres de tes amis',
  map_show_qr_instruction: 'Demande à tes amis de scanner ce code.',
  map_scan_qr_instruction: 'Scanne les QR codes de tes amis pour obtenir leurs lettres.',

  map_tutorial_1_title: 'Bienvenue dans le FLUX !',
  map_tutorial_1_text: 'Choisis TA lettre en appuyant sur le symbole + en bas à gauche',
  map_tutorial_2_title: 'Bien joué, [LETTER] !',
  map_tutorial_2_text: "Écris sur la carte en faisant glisser ta lettre à l'intérieur du cercle.",
  map_tutorial_3_title: 'Joli !',
  map_tutorial_3_text: 'Tu te sens seul ? Appuie sur ta lettre pour la partager avec tes amis.',
  ...
  map_photo_save_text: "Retrouve tes photos dans l'album de ton téléphone.",
